...
class WebCam:
    def __init__(self, id: str):
        ...
        self.DECIMATION = settings["storage"]["decimation"]
    ...
    def detect(self) -> np.ndarray:
        ...
        #print(os.path.getsize(os.path.join(os.path.dirname(os.path.abstract(__file__)), "rec/"))
        #print(get_directory_size(os.path.join(os.path.dirname(os.path.realpath(__file__)), "rec")))
        if not ret:
        ...
        if self.STORE_DATA and self.frame_count%self.DECIMATION==0 and get_directory_size(os.path.join(os.path.dirname(os.path.realpath(__file__)), "rec")) < 9e10:
        ...
        for det in detections:
            ...
            # TODO: gives error in pi, don't know why (likely version differences of the library as WPILIBPi was last updated in 2024)
            # Do more research on how to use it
        ...
        # Prints the FPS, comment it during comp to avoid overloading the terminal
...
# Only run the webcam (beware of the while true!!!)
# while True:
